...
const GROUPS: { title: string; description: string; entries: Entry[] }[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      {
        description: "Выбрано: источники, провайдеры и прокси списком → деталью в «Погружении»; модели включаются в источнике и у провайдера. Рядом прошлые варианты.",
      ...
      {
        description: "Выбрано и в продукте: плавающая панель с вкладками «Возможности / Цены / О модели». Рядом остальные варианты обоих раундов.",
